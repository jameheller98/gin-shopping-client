          ...
          <li className="marker:font-medium">
            <article className="flex flex-col gap-2">
              ...
              <p className="font-light">
                A: You can order easily using our online platform. When you find
                a product you need, you can add it to cart, login and go through
          ...
          <li className="marker:font-medium">
            <article className="flex flex-col gap-3">
              ...
              <p className="font-light">
                ...
                confirmation and payment process much faster. This could save
                days of your time.
              </p>
            </article>
          </li>
        ...
        <ol className="list-decimal flex flex-col gap-10">
          ...
          <li className="marker:font-medium">
            <article className="flex flex-col gap-2">
              ...
              <p className="font-light">
                A: Our web store is secured with SSL certificate. This means the
                information you input is encrypted and it will not be available
                for third parties.
              </p>
            </article>
          </li>
