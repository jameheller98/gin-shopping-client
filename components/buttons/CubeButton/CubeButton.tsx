...
const CubeButton: React.FC<TCubeButton> = ({
  ...
  return (
    ...
    >
      <span
        className={`relative rounded-lg shadow-[inset_0px_-20px_100px_-70px_rgba(0,0,0,0.5)] border-2 text-white px-2 py-[2px] inline-block z-[1] transition-transform duration-100 group-active:translate-y-[2px] ${bgColor} ${borderColor}`}
      >
        {children}
      </span>
    </button>
